...
TEST_CASE("operator>") {
    ...
    CHECK(!(100 > bigint("100")));
    CHECK(!(bigint("100") > 100));
    CHECK(bigint("11100") > bigint("1111"));  // BASE 1000
}
...
TEST_CASE("Leading zeros do not matter") {
    ...
    CHECK(bigint("0000000").to_string() == "0");
}
...
TEST_CASE("operator+= and operator+") {
    ...
    CHECK("1000000000000000000000000009999" ==
...
TEST_CASE("operator-= and operator-") {
    ...
    CHECK("999999999999999999999999999999" ==
